      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col col-md-12">
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="ID_ESCRIBE"  placeholder="Ingrese la identificación del artículo" required>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="row">
                    ...
                    echo "<select class='form-control' id=\"ARTICULO_ID\">";
             ...
             <div class="row">
                    ...
                    echo "<select class='form-control' id=\"AUTOR_ID\">";

                       while ($fila = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) {
                              echo "<option value=\"".$fila['ID_AUTOR']."\"> ".$fila['NOMBRE_AUTOR']." ".$fila['APELLIDO1']." ".$fila['APELLIDO2']."</option>";
                    }
                     echo "</select>";
