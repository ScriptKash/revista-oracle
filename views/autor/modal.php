        ...
        <div class="modal-body">
             ...
             <div class="row">
                    <div class="col col-md-12">
                      ...
                      <div class="col col-md-9">
                    <div class="input-group">
                    <input type="text" class="form-control" id="ADSCRIPCION" placeholder="Ingrese el correo electrónico" required>
                    </div>
                   </div>
                 </div>
                </div>
             ...
             <div class="row">
                    <div class="col col-md-12">
                      ...
                      <div class="col col-md-9">
                    <div class="input-group">
                    <input type="text" class="form-control" id="POSICION" placeholder="Ingrese el correo electrónico" required>
                    </div>
                   </div>
                 </div>
                </div>
